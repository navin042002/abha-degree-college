            ...
            <div class="grid md:grid-cols-2">
              <div class="h-full pr-6">
                <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                  This College belongs to the genre of new generation institutes
                  of national importance in higher education in the domain of
                ...
                <ul class="mb-6 md:mb-0">
                  ...
                  <li class="flex">
                    ...
                    <div class="ml-4 mb-4">
                      ...
                      <p class="text-gray-600 dark:text-slate-400">
                        Mobile: +91 9334900239
                      </p>
                      <p class="text-gray-600 dark:text-slate-400">
                        Mail: abhadegree@gmail.com
                      </p>
                    </div>
                  </li>
                  <li class="flex">
